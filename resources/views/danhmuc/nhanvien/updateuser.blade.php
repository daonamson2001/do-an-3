        ...
        <div class="modal-body " >
          ...
          <form action="#" id="form-update">
            ...
            <div class="form-group row select-gender">
                ...
                <select class="col-md-6 form-control" name="gender" id="u-gender" class="form-control" name="gender" >
            ...
            <div class="form-group row select-position">
                ...
                <select class="col-md-6 form-control" name="postion" id="u-postion" class="form-control" name="postion" >
                  <option name="postion" value="1">Admin</option>
                  <option name="postion" value="2">Lãnh Đạo</option>

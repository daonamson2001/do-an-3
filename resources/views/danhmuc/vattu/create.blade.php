    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title">Thêm Vật Tư</h4>
        ...
        <div class="modal-body " >
          ...
          <form action="#" id="form-create" >
            ...
            <div class="form-group row">
                ...
                <input type="number" class="col-md-6 form-control" id="c-sup_amount" min="0" required/>
            </div>

            <div class="form-group row">
              <label class="col-md-4 text-md-right font-weight-bold" >Đơn Vị Tính</label>
              <select class="col-md-6 form-control"  name="c-unit_id" id="c-unit_id" class="form-control" required>
                  <option value="">-- Chọn --</option>
                  @foreach ($units as $unit)
                  <option name="c-unit_id" value="{{$unit->id}}">{{$unit->unit_name}}</option>
                  @endforeach  
              </select>
            </div>

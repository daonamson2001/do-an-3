...
<body>
            ...
            <thead>
                <tr>
                    ...
                    <th width="300px">
                        ...
                        <center>Ngày lập phiếu: {{\Carbon\Carbon::parse($data['info']['imp_date'])->format('d/m/Y')}}</center>
                    </th>
                    <th width="50px">
                        <center>Mã Nhập : {{$data['info']['imp_code']}}</center>
                    </th>
                </tr>
            </thead>
        ...
        <tbody>
            ...
            @foreach ($data['arr'] as $item)
                ...
                <tr>
                    ...
                    <td style="border:thin solid;">
                        {{\Carbon\Carbon::parse($item['imp_date'])->format('d/m/Y')}}
                    </td>

                    <td style="border:thin solid;">
                        {{number_format($item['imp_total'])}}
                    </td>
                </tr>
            @endforeach
    ...
    <table style="margin-bottom:30px;">
        <tr>
            <td width="200px"></td>
            <td width="200px"></td>
            <td>Nhập,Ngày lập: {{\Carbon\Carbon::parse($data['info']['imp_date'])->format('d/m/Y')}}</td>
        </tr>
        <tr>

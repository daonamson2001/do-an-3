                                    ...
                                    <tr>
                                        <td width="50%" > 
                                            <div class="form-group row">
                                                ...
                                                <input type="text" id="exp_code" class="col-md-6 form-control" name="exp_code"
                                                value="{{session('id')}}XK<?php $x=count($exps)+1; echo date("dm").$x;  ?>" readonly required>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <td width="50%" >
                                            ...
                                            @if (session('dpm_id')=== 1 || session('dpm_id')=== 2 || session('dpm_id')=== 3)
                                                <div class="form-group row">
                                                    <label for="exp_date" class="col-md-3 col-form-label text-md-right">Ngày Lập Phiếu</label>
                                                    <input type="date" id="exp_date" class="col-md-6  form-control" name="exp_date"  required>
                                                </div>
                                            @else
                                                <div class="form-group row">
                                                    <label for="exp_date" class="col-md-3 col-form-label text-md-right">Ngày Lập Phiếu</label>
                                                    <input type="date" id="exp_date" class="col-md-6  form-control" name="exp_date" readonly  required>
                                                </div>
                                            @endif  
                                    ...
                                    <tr>    
                                        <td colspan="2" >
                                            <div class=" row">
                                                ...
                                                <label id="sup_name"  class="col-md-2 form-control text-left mx-3">Tên Vật Tư</label>

                                                <label id="unit_name"  class="col-md-2 form-control text-left">ĐVT</label>
                                                ...
                                                <input type="number" id="sup_amout" class="col-2 ml-3 form-control" name="sup_amout" placeholder="Số Lượng" min="0" required>
                                                <input type="number" class="col-2 mx-3 form-control" name="de_price" id="de_price" placeholder="Giá" min="0" required>

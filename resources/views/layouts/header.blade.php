...
<div class="category bg-dark navbar-dark " id="accordion">
    ...
    <ul class="navbar-nav">
      @if(session('dpm_id')===1 || session('dpm_id')===2)
        <li class="nav-item border-right border-secondary  ml-2">
          <a href="{{ route('dangky.index') }}" class="nav-link px-2 btn"><i class="fas fa-users-cog"></i> Tạo Tài Khoản</a>
        </li>
      @endif
      <li class="nav-item ">
        <a href="{{ route('thongtin.index') }}" class="nav-link px-2 btn" ><i class="fas fa-info"></i> Thông Tin Công Ty</a>
      </li>
  ...
  <div class="collapse navbar-collapse " id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordion">
    <ul class="navbar-nav">
      ...
      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('xuat.index') }}" class="nav-link px-2 btn" ><i class="fas fa-file-export"></i> Xuất Kho</a>
      </li>

      <li class="nav-item ">
        <a href="{{ route('nhap.index') }}" class="nav-link px-2 btn" ><i class="fas fa-file-import"></i> Nhập Kho</a>
      </li>
  ...
  <div class="collapse navbar-collapse " id="collapseThree" aria-labelledby="headingThree" data-parent="#accordion">
    <ul class="navbar-nav">
      <li class="nav-item border-right border-secondary  ml-2">
        <a href="{{ route('chatluong.index') }}" class="nav-link px-2 btn"><i class="fas fa-award"></i> Chất Lượng</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('donvitinh.index') }}" class="nav-link px-2 btn" ><i class="fas fa-weight-hanging"></i> Đơn Vị Tính</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('khuvuc.index') }}" class="nav-link  px-2 btn" ><i i class="fab fa-fort-awesome-alt"></i> Khu Vực</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('nhanvien.index') }}" class="nav-link px-2 btn" ><i class="fas fa-user-tie"></i> Nhân Viên</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('nhasanxuat.index') }}" class="nav-link px-2 btn" ><i class="fas fa-box-open"></i> Nhà Sản Xuất</a>
      </li>

      <li class="nav-item ">
        <a href="{{ route('vattu.index') }}" class="nav-link px-2 btn" ><i class="fas fa-toolbox"></i> Vật Tư</a>
      </li>
  </div>  
  ...
  <div class="collapse navbar-collapse " id="collapseFour" aria-labelledby="headingFour" data-parent="#accordion">
    <ul class="navbar-nav">
      <li class="nav-item border-right border-secondary  ml-2">
        <a href="{{ route('huongdan') }}" class="nav-link px-2 btn"><i class="far fa-question-circle"></i> Hướng Dẫn Sử Dụng</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('lienhe.index') }}" class="nav-link px-2 btn" ><i class="fas fa-phone-alt"></i> Liên Hệ</a>
      </li>

      <li class="nav-item border-right border-secondary  ">
        <a href="{{ route('phanhoi.index') }}" class="nav-link px-2 btn" ><i class="far fa-comments"></i> Phản Hồi</a>
      </li>

      <li class="nav-item ">
        <a href="{{ route('thongtinphanmem') }}" class="nav-link px-2 btn" ><i class="far fa-file-alt"></i> Thông Tin Phần Mềm</a>
      </li>
  </div>  
  </div>